    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle("Добавить заметку в истории?")
                ...
                .setPositiveButton("Сохранить", (dialog, id) -> {
                    ...
                    ru.mirea.zlotov.mireaproject.ui.histories.AppDatabase db = ru.mirea.zlotov.mireaproject.ui.histories.App.getInstance().getDatabase();
                    ru.mirea.zlotov.mireaproject.ui.hihistories.HistoryDao historyDao = db.storyDao();
                    ru.mirea.zlotov.mireaproject.ui.histories.Cell cell = new ru.mirea.zlotov.mireaproject.ui.histories.Cell();
                ...
                .setNeutralButton("Очистить истории",
                        (dialog, id) -> {
                            ...
                            ru.mirea.zlotov.mireaproject.ui.histories.AppDatabase db = ru.mirea.zlotov.mireaproject.ui.histories.App.getInstance().getDatabase();
                            ru.mirea.zlotov.mireaproject.ui.hihistories.HistoryDao historyDao = db.storyDao();
                            List<ru.mirea.zlotov.mireaproject.ui.histories.Cell> cells = historyDao.getAll();
                            for (ru.mirea.zlotov.mireaproject.ui.histories.Cell cell : cells){
